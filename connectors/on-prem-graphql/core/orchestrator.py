"""
GraphQL Orchestrator - Pipeline coordination for Magento B2B On-Prem -> Veza OAA.
...
from config.settings import PROXY_ENV_VARS, PROVIDER_NAME as DEFAULT_PROVIDER_NAME


class GraphQLOrchestrator:
    """Orchestrates the Magento On-Prem GraphQL extraction pipeline."""
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Step 7: Save JSON and/or push to Veza
            if self.save_json:
