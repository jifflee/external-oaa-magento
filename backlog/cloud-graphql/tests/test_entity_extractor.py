"""Tests for core.entity_extractor (Commerce Cloud GraphQL).

The entity extractor is identical to the magento-graphql on-prem version;
these tests verify that the shared logic behaves correctly when imported from
the commerce-cloud-graphql connector's core package.
"""
