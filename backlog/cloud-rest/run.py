...
Adobe Commerce Cloud B2B -> Veza OAA via REST API with Adobe IMS OAuth.
...
from core import CloudRESTOrchestrator


def main():
    parser = argparse.ArgumentParser(
        description="Adobe Commerce Cloud REST Connector - Extract authorization data for Veza"
    )
    ...
    orchestrator = CloudRESTOrchestrator(env_file=args.env)
    ...
    print(f"\n{'='*60}")
    print("COMMERCE CLOUD REST CONNECTOR")
    print("="*60)
