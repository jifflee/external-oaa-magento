"""Tests for core.orchestrator.CloudRESTOrchestrator.validate_config().
...
def _make_orchestrator(env_overrides=None):
    ...
    with patch.dict(os.environ, env, clear=True), \
        ...
        from core.orchestrator import CloudRESTOrchestrator
        orch = CloudRESTOrchestrator(env_file="/nonexistent/.env")
    return orch
