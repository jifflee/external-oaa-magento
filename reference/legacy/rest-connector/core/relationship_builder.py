"""
Relationship Builder - Wires up all OAA relationships for REST connector.
...
from config.permissions import MAGENTO_ACL_PERMISSIONS
        ...
        for role in roles:
            ...
            for perm in role.get("permissions", []):
                ...
                if perm.get("permission") == "allow" and resource_id in MAGENTO_ACL_PERMISSIONS:
                    try:
                        local_role.add_permission(permission=resource_id, apply_to_application=True)
                    except Exception:
                        pass
